...
## ![](pics/Citation20230821.png){width="400"}

Last updated on `r format(Sys.Date(), "%b %d, %Y")`.

## Skills

Full experience with study design, and management of clinical trials, such as RCTs.

Experience in leading 2-3 research teams of 10-20 members.

Experienced in clinical statistical analysis, bioinformatics, and design new algorithms.
...
The intricacies of the central nervous system pose challenges in studying neuro-psychiatric disorders. A recent technique involving the enrichment of brain-derived extracellular vesicles (BDEVs) from peripheral blood can provides direct *in vivo* CNS data, bypassing the blood-brain barrier. However, for those rapidly changing CNS disorders like encephalitis, depression, bipolar disorder, and others, the standard biometric sampling frequency (half-yearly or yearly) falls short in capturing molecular signaling trajectories, in line with the Nyquist-Shannon sampling theorem.

In response, I innovated a method to isolate BDEVs from urine. Urinary BDEVs enable non-invasive, frequent *in vivo* CNS signal collection, satisfying Nyquist-Shannon sampling theorem criteria. This advancement facilitates the depiction of intricate paths of CNS-specific molecular signaling linked to these swiftly evolving neuropsychiatric disorders. This, in turn, aids in comprehending disease mechanisms and developing suitable treatment strategies.

Consequently, my aspiration is to secure a suitable position that allows me to delve deeply into neuro-psychiatric disorders using this cutting-edge technique. I am particularly driven to discover novel biological markers, elucidate swift pathological mechanisms, enhance diagnostic strategies, and formulate improved treatment approaches for neuro-psychiatric disorders.
...
Investigating the status of neuroinflammation and neurogenesis in patients with major depressive disorder (MDD) using plasma/serum astrocyte-derived extracellular vesicles (ADEVs) and neuro-derived EVs (NDEVs), and the changes before and after electroconvulsive therapy (ECT). The advantage of these brain-derived extracellular vesicles (BDEVs) is that they directly reflect the *in vivo* changes in the central nervous system (CNS), and are considered to be "windows to the brain".

Based on the [two-hit hypothesis of depression](https://doi.org/10.1002/wps.20556), I designed a new rat model that has the advantages of stable modeling effect and can better simulate the damage of neural synapses and neurotransmitter pathways such as GABA in patients with depression.
...
Schizophrenia patients have similar basic saccade parameters to healthy controls during visually guided saccade, such as amplitude, duration, latency, and accuracy rate. However, I designed an algorithm called the asymmetric acceleration index (AAI) to compute the asymmetry of saccade acceleration. I found that schizophrenia patients had a significantly lower correlation coefficient (RAD) between AAI and saccade duration than healthy controls ([Cui *et al*., 2014](https://doi.org/10.1371/journal.pone.0097308)).
...
-   **Innovative ECT Strategy**: Created Hybrid-ECT, a pioneering approach combining efficacy of standard ECT with reduced cognitive side effects. And further evolved into iHECT, currently in progressive stages.
-   **Schizophrenia and CAC**: Uncovered increased coronary artery calcium (CAC) in schizophrenia patients through COVID-19 chest CT analysis. Identified potential risk factors including elevated triglycerides and decreased Triiodothyronine (manuscript under review).
-   **Gut Microbiota in Mood Disorders**: Explored gut microbiota in patients with major depressive or bipolar disorder, highlighting distinctive microbiota patterns and links to the gut microbial tryptophan biosynthesis and metabolism pathway (MiTBamp).
-   **Additional Research Endeavors**: Engaged in meta-analysis of MRI network topology in depression patients.

### Psychiatrist

Department of Psychiatry, Shenzhen Mental Health Center (Shenzhen Kangning Hospital)
...
Xu, S. X.#, [**Xie, X. H.#**]{.underline}, Yao, L., Chen, L. C., Wan, Q., Chen, Z. H., & Liu, Z.\* (Comment: XXXX)
...
[**Xie, X. H.#**]{.underline}, Lai, W. T., Xu, S. X., Forti, M. D., Zhang, J. Y., Chen, M. M., Yao, L. H., Wang, P. L., Hao, K. K., & Han, R.\* (Comment: XXXX)
...
Xu, S. X.#, [**Xie, X. H.#**]{.underline}, Su, D., & Liu, Z.\* (Comment: XXXX)
...
Yang, F.#, [**Xie, X. H.#**]{.underline}, Li, X., Liao, H. N., & Zou, B.\* (Comment: XXXX)
