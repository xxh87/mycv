...
In response, **I devised a novel method for isolating BDEVs from urine. It can facilitate non-invasive and frequent, even semi-daily, collection of *in vivo* CNS signals** (*The 23rd WPA World Congress of Psychiatry, #4041*). With the advantages of BDEVs, this **urinary BDEV (uBDEV) approach has the potential to delineate intricate trajectories of CNS-specific molecular signals at the individual level** (*see schematic diagram below*). In my opinion, it means that for CNS diseases, especially those that change rapidly, there is now an entire new set of tools available for research.

![](pics/schematic diagram.png)
